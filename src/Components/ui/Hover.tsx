...
const Transition: React.FC<{ value: object | undefined; children: React.ReactNode }> = ({ value, children }) => {
...
export const IconHover3D: React.FC<Props & { children?: React.ReactNode }> = ({
  heading = "Library",
          ...
          <Transition value={transition1}>
            <motion.div
              ...
              style={{
                ...
                border: isHoverVariant ? "2px solid #8b2ffa" : "1px solid color-mix(in srgb, var(--foreground) 10%, transparent)",
                boxShadow: isHoverVariant ? "0 0 32px 8px #8b2ffa55, 0 2px 16px 0 #0008" : "0 2px 8px 0 #0004",
            ...
            >
              ...
              >
                ...
                {/* Render children (icon) on top of 3D effect, and animate scale on hover */}
                {children && (
                  <motion.span
                    style={{ position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%, -50%)', zIndex: 10, pointerEvents: 'none' }}
                    animate={{ scale: isHoverVariant ? 1.2 : 1 }}
