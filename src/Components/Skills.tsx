...
function Skills() {
	...
	return (
		<section
			id='skills'
			className='min-h-screen py-20 bg-gradient-to-b from-zinc-900/50 to-black relative'
		>
			{/* Animated gradient background */}
			<div
				className='absolute -top-8 left-0 w-full h-20 pointer-events-none z-30'
				style={{
					background:
						"linear-gradient(to bottom, rgba(0,0,0,1) 0%, rgba(24,24,27,0.85) 60%, rgba(24,24,27,0) 100%)",
				}}
			/>
